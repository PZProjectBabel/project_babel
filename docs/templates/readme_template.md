...
1.  前往我们的 Steam 创意工坊页面：{{md_link_1}}
2.  点击「订阅」按钮。
...
- **署名（BY）**：在明显位置注明“本翻译项目基于『Project Babel』的工作成果进行修改”，并附上本仓库和 Steam 创意工坊链接   `{{steam_workshop_link}}`
...
完整条款请参见本仓库根目录下的 `LICENSE` 文件（GPL-3.0），或访问 GNU 官网：<{{gpl_license_link}}>。
...
| 参考模组名称 | 作者 | 模组页面 |
|------|------|------|
| [B42]统一·中文汉化 | 如一汉化组 (As1) | [创意工坊页面]({{url_0}}) |
| [B42]统一·模组汉化 | 如一汉化组 (As1) | [创意工坊页面]({{url_1}}) |
| [B42]统一·方舟汉化 | 如一汉化组 (As1) | [创意工坊页面]({{url_2}}) |
