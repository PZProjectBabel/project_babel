...
**流水线模块（`src/`，C# / .NET 10）**：包含 15 个按序执行的模块，负责从 SteamCMD 初始化、模组下载、文本提取、内容审查、Embedding 计算、RAG 检索到 LLM 翻译与最终输出的完整流程。详见 [技术参考](../technical_reference/technical_reference_zh-hans.md)。
