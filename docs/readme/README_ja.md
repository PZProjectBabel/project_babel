...
|------|------|------|------|------|------|
| アラビア語 | العربية | `ar` | `AR` | ❌ | 資金不足 |
| カタルーニャ語 | català | `ca` | `CA` | ❌ | 資金不足 |
| 繁体字中国語 | 繁體中文 | `zh-hant` | `CH` | ❌ | 資金不足 |
| 簡体字中国語 | 简体中文 | `zh-hans` | `CN` | ✅ | |
| チェコ語 | čeština | `cs` | `CS` | ❌ | 資金不足 |
| デンマーク語 | dansk | `da` | `DA` | ❌ | 資金不足 |
| ドイツ語 | Deutsch | `de` | `DE` | ✅ | |
| 英語 | English | `en` | `EN` | ✅ | |
| スペイン語 | español | `es` | `ES` | ❌ | 資金不足 |
| フィンランド語 | suomi | `fi` | `FI` | ❌ | 資金不足 |
| フランス語 | français | `fr` | `FR` | ✅ | |
| ハンガリー語 | magyar | `hu` | `HU` | ❌ | 資金不足 |
| インドネシア語 | Bahasa Indonesia | `id` | `ID` | ❌ | 資金不足 |
| イタリア語 | italiano | `it` | `IT` | ❌ | 資金不足 |
| 日本語 | 日本語 | `ja` | `JP` | ✅ | |
| 韓国語 | 한국어 | `ko` | `KO` | ❌ | 資金不足 |
| オランダ語 | Nederlands | `nl` | `NL` | ❌ | 資金不足 |
| ノルウェー語 | norsk | `no` | `NO` | ❌ | 資金不足 |
| タガログ語 | Tagalog | `tl` | `PH` | ❌ | 資金不足 |
| ポーランド語 | polski | `pl` | `PL` | ❌ | 資金不足 |
| ポルトガル語（ポルトガル） | português | `pt` | `PT` | ❌ | 資金不足 |
| ポルトガル語（ブラジル） | português do Brasil | `pt-br` | `PTBR` | ❌ | 資金不足 |
| ルーマニア語 | română | `ro` | `RO` | ❌ | 資金不足 |
| ロシア語 | русский | `ru` | `RU` | ❌ | 資金不足 |
| タイ語 | ภาษาไทย | `th` | `TH` | ❌ | 資金不足 |
| トルコ語 | Türkçe | `tr` | `TR` | ❌ | 資金不足 |
| ウクライナ語 | українська | `uk` | `UA` | ❌ | 資金不足 |
