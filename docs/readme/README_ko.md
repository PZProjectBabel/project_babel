...
|------|------|------|------|------|------|
| 아랍어 | العربية | `ar` | `AR` | ❌ | 자금 부족 |
| 카탈루냐어 | català | `ca` | `CA` | ❌ | 자금 부족 |
| 번체 중국어 | 繁體中文 | `zh-hant` | `CH` | ❌ | 자금 부족 |
| 간체 중국어 | 简体中文 | `zh-hans` | `CN` | ✅ | |
| 체코어 | čeština | `cs` | `CS` | ❌ | 자금 부족 |
| 덴마크어 | dansk | `da` | `DA` | ❌ | 자금 부족 |
| 독일어 | Deutsch | `de` | `DE` | ✅ | |
| 영어 | English | `en` | `EN` | ✅ | |
| 스페인어 | español | `es` | `ES` | ❌ | 자금 부족 |
| 핀란드어 | suomi | `fi` | `FI` | ❌ | 자금 부족 |
| 프랑스어 | français | `fr` | `FR` | ✅ | |
| 헝가리어 | magyar | `hu` | `HU` | ❌ | 자금 부족 |
| 인도네시아어 | Bahasa Indonesia | `id` | `ID` | ❌ | 자금 부족 |
| 이탈리아어 | italiano | `it` | `IT` | ❌ | 자금 부족 |
| 일본어 | 日本語 | `ja` | `JP` | ✅ | |
| 한국어 | 한국어 | `ko` | `KO` | ❌ | 자금 부족 |
| 네덜란드어 | Nederlands | `nl` | `NL` | ❌ | 자금 부족 |
| 노르웨이어 | norsk | `no` | `NO` | ❌ | 자금 부족 |
| 타갈로그어 | Tagalog | `tl` | `PH` | ❌ | 자금 부족 |
| 폴란드어 | polski | `pl` | `PL` | ❌ | 자금 부족 |
| 포르투갈어 (포르투갈) | português | `pt` | `PT` | ❌ | 자금 부족 |
| 포르투갈어 (브라질) | português do Brasil | `pt-br` | `PTBR` | ❌ | 자금 부족 |
| 루마니아어 | română | `ro` | `RO` | ❌ | 자금 부족 |
| 러시아어 | русский | `ru` | `RU` | ❌ | 자금 부족 |
| 태국어 | ภาษาไทย | `th` | `TH` | ❌ | 자금 부족 |
| 터키어 | Türkçe | `tr` | `TR` | ❌ | 자금 부족 |
| 우크라이나어 | українська | `uk` | `UA` | ❌ | 자금 부족 |
